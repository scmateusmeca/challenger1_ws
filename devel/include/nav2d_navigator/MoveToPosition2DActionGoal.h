...
bool operator==(const ::nav2d_navigator::MoveToPosition2DActionGoal_<ContainerAllocator1> & lhs, const ::nav2d_navigator::MoveToPosition2DActionGoal_<ContainerAllocator2> & rhs)
{
