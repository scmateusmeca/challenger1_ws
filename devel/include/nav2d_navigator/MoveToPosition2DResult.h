...
bool operator==(const ::nav2d_navigator::MoveToPosition2DResult_<ContainerAllocator1> & lhs, const ::nav2d_navigator::MoveToPosition2DResult_<ContainerAllocator2> & rhs)
{
  return lhs.final_pose == rhs.final_pose &&
    lhs.final_distance == rhs.final_distance;
}
