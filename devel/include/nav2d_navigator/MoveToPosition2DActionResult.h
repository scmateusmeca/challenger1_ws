...
bool operator==(const ::nav2d_navigator::MoveToPosition2DActionResult_<ContainerAllocator1> & lhs, const ::nav2d_navigator::MoveToPosition2DActionResult_<ContainerAllocator2> & rhs)
{
