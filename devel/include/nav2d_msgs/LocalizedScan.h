...
bool operator==(const ::nav2d_msgs::LocalizedScan_<ContainerAllocator1> & lhs, const ::nav2d_msgs::LocalizedScan_<ContainerAllocator2> & rhs)
{
  return lhs.robot_id == rhs.robot_id &&
    lhs.laser_type == rhs.laser_type &&
    lhs.x == rhs.x &&
    lhs.y == rhs.y &&
    lhs.yaw == rhs.yaw &&
    lhs.scan == rhs.scan;
